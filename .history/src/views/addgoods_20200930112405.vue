<template>
  <div>
    ...
    <div style="margin-top:20px">
        <el-tabs :tab-position="tabPosition" style="height: 300px;width:1400px" v-model="editableTabsValue">
          ...
          <el-tab-pane label="商品参数" :disabled="didi1">配置管理</el-tab-pane>
          <el-tab-pane label="商品属性" :disabled="didi2">角色管理</el-tab-pane>
          <el-tab-pane label="商品图片" :disabled="didi3">定时任务补偿</el-tab-pane>
          <el-tab-pane label="商品内容" :disabled="didi4">定时任务补偿</el-tab-pane>
        </el-tabs>
  ...
  methods: {
    xiayibu(){
      if( this.active >0){
        ...
        this.active ++
        this.editableTabsValue = this.active
      }
    }
  },
  //调用
