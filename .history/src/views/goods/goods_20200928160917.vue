      ...
      <el-card>
        ...
        <el-dialog title="编辑商品" :visible.sync="dialogVisible">
          ...
          >
            ...
            <el-form-item label="商品价格" :label-width="formLabelWidth" prop="goods_name">
              <el-input v-model="form.hot_mumber" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="商品数量" :label-width="formLabelWidth" prop="goods_name">
              <el-input
                v-model="form.goods_number"
                autocomplete="off"
              ></el-input>
            </el-form-item>
            <el-form-item label="商品重量" :label-width="formLabelWidth" prop="goods_name">
              <el-input
