<template>
  <div>
    ...
    >
      ...
      <template v-solt:likes333="scope">
        <el-button type="primary" @click="add(scope.scope="this api replaced by slot-scope in 2.5.0+")">
          <i class="el-icon-edit"></i>
          <span>编辑</span>
        </el-button>
        <el-button type="danger" @click="del(scope.scope)">
