    ...
    <div>
      <el-dialog title="编辑分类" :visible.sync="dialogFormVisible">
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="app(scope)">确 定</el-button>
        </div>
      </el-dialog>
    </div>
  </div>
...
export default {
  ...
  //监听方法  click事件等
  methods: {
    ...listActions(["getcategories", "getcategoriesfa", "getcategoriespo"]),
    ...
    add(row) {
      // console.log(row);
      (this.id = row.cat_id), console.log(row.cat_id, 111);
